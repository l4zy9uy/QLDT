...
const RegisterForClassScreen = () => {
    ...
    const [classDetails, setClassDetails] = useState([
        {
            id: '1',
            classCode: 'CS101',
            linkedClassCode: 'CS101-A',
            className: 'Computer Science Basics',
            teacher: 'Mr. John',
            time: 'Mon, 10:00 AM'
        },
        {
        ...
        },
        {
            id: '4',
            classCode: 'CH104',
            linkedClassCode: 'CH104-B',
            className: 'Intro to Chemistry',
            teacher: 'Dr. Brown',
            time: 'Thu, 1:30 PM'
        },
        {
        ...
        },
        {
            id: '6',
            classCode: 'EC106',
            linkedClassCode: 'EC106-D',
            className: 'Economics Basics',
            teacher: 'Mr. White',
            time: 'Mon, 3:00 PM'
        },
        {
    ...
    return (
        <View style={styles.container}>
            <TopBar
                leftComponent={<Ionicons name="arrow-back-outline" size={24}
                                         color="white"/>}
                centerComponent={<Text style={styles.headerText}>REGISTER FOR
                    CLASS</Text>}
                rightComponent={<View/>}
            ...
            <ScrollView contentContainerStyle={styles.formContainer}>
                <View style={styles.inputContainer}>
                    ...
                    />
                    <TouchableOpacity style={styles.registerButtonInside}
                ...
                <View style={styles.row}>
                    <TouchableOpacity style={styles.submitButton}
                                      onPress={handleSendRegistration}>
